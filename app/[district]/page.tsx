...
const PROJECT_DATA = {
  hay1: {
    ...
    areas: {
      ar: ["شقة 180م²", "شقة 200م²", "شقة 220م²"],
      en: ["180m² Apt", "200m² Apt", "220m² Apt"],
    },
    features: {
      ar: [
...
const TR = {
  ar: {
    ...
    noProjectSub:
      "سنضيف مشروعات قريباً — اترك بياناتك وسنتواصل معك فور الإتاحة",
  ...
  en: {
    ...
    noProjectSub:
      "We're adding projects soon — leave your details and we'll reach out immediately",
          ...
          <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2.5 min-w-0">
              ...
              <div className="hidden sm:block min-w-0">
                <p
                  className={`font-black text-xs leading-none tracking-widest truncate ${tp}`}
                >
                  DAR EL ARKAN
                </p>
                <p className="text-amber-500 text-xs tracking-wider mt-0.5">
                  DEVELOPMENTS
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-1.5">
              ...
              <button
                ...
                className={`w-8 h-8 flex items-center justify-center rounded-lg border transition-all ${
                  dark
                    ? "border-gray-600 text-amber-400 hover:bg-gray-700"
                    : "border-gray-200 text-gray-600 hover:bg-gray-50"
                }`}
              >
                {dark ? "☀️" : "🌙"}
        ...
        >
          ...
          <div className="relative max-w-5xl mx-auto px-4 py-10 sm:py-14 text-center text-white">
            ...
            <div className="flex items-center justify-center gap-3 mt-3">
              ...
              <span className="text-amber-400 text-xs tracking-widest font-light">
                BAYT AL-WATAN
              </span>
              <div className="h-px w-10 bg-amber-400" />
            </div>
        ...
        <div className="max-w-5xl mx-auto px-4 py-10 space-y-8">
          ...
          {hasProject && proj && (
            <>
              ...
              {/* Main card */}
              <div
                className={`rounded-3xl overflow-hidden border shadow-xl ${card}`}
              >
                {/* Image */}
                <div
                ...
                {/* Stats row */}
                <div
                  className={`grid grid-cols-2 sm:grid-cols-4 gap-3 p-5 ${
                    dark ? "bg-gray-800" : "bg-gray-50"
                  }`}
                >
                  <StatPill
                    label={tr.priceLabel}
                    value={proj.pricePerMeter[lang]}
                    dark={dark}
                  />
                  <StatPill
                    label={tr.downLabel}
                    value={proj.downPayment}
                    dark={dark}
                  />
                  <StatPill
                    label={tr.installLabel}
                    value={proj.installment[lang]}
                    dark={dark}
                  />
                  <StatPill
                    label={tr.deliveryLabel}
                    value={proj.delivery[lang]}
                    dark={dark}
                  />
                </div>
                      ...
                      {proj.areas[lang].map((area, i) => (
                        <span
                          ...
                          className={`px-4 py-2 rounded-xl text-sm font-bold border ${
                            dark
                              ? "bg-gray-700 border-gray-600 text-amber-300"
                  ...
                  <div>
                    ...
                    <ul className="space-y-2.5">
                      {proj.features[lang].map((f, i) => (
                        <li
                          key={i}
                          className={`flex items-start gap-2.5 text-sm ${ts}`}
                        >
                ...
                {/* CTA buttons */}
                <div
                  className={`px-5 pb-6 sm:px-8 flex flex-col sm:flex-row gap-3 border-t ${
                    dark ? "border-gray-700 pt-5" : "border-gray-100 pt-5"
                  }`}
                >
                  <a
                    href={proj.whatsapp}
          ...
          {NO_PROJECTS.includes(district) && (
            ...
            >
              ...
              <p className={`text-sm leading-7 max-w-md mx-auto ${ts}`}>
                {tr.noProjectSub}
              </p>
            </div>
          )}
          ...
          {/* ── INQUIRY FORM ─────────────────────────────────────────── */}
          <div
            className={`rounded-3xl border shadow-lg overflow-hidden ${card}`}
          >
            {/* Form header */}
            <div
          ...
          {/* ── FOOTER STRIP ─────────────────────────────────────────── */}
          <div
            className={`rounded-2xl border p-5 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm ${card}`}
          >
            <div className="flex items-center gap-3">
              <Logo size={36} />
              <div>
                <p className={`font-black text-xs tracking-widest ${tp}`}>
                  DAR EL ARKAN DEVELOPMENTS
                </p>
                <p className={`text-xs ${ts}`}>
                  224 ش التسعين الشمالي — القاهرة الجديدة
                </p>
              </div>
            </div>
            <div className="flex items-center gap-3">
