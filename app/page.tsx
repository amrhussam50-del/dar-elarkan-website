...
// ─── TYPEWRITER HOOK ──────────────────────────────────────────────────────────
function useTypewriter(text: string, speed = 75, startDelay = 400) {
      ...
      >
        ...
        >
          ...
          <div className="relative w-full max-w-3xl text-white z-10 px-2">
            ...
            <p
              className="text-amber-400 text-xs sm:text-sm font-semibold tracking-widest uppercase mb-4"
              style={{
                opacity: 1,
            ...
            >
              ...
              {!typingDone && (
                <span
                  className="inline-block w-[3px] align-middle bg-amber-400 ms-1"
                  style={{
                    height: "0.85em",
